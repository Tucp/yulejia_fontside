<template lang="html">
  <div class="fish allbg" >
      <div class="addfishfield" @click="addfishing" v-show="isShowAdd">
        <p>
          +
          <p class="text">添加钓场</p>
        </p>
    ...
    <div class="select">
      ...
      <div class="zhineng sec" :class="{isBorder: Tab ==='brief2'}" @click.stop.prevent="sort('brief2')">
        {{sorttext}}<span class="sanB" v-show="bottom2"></span><span class="sanA" v-show="top2"></span>
      </div>
...
export default {
    ...
    methods: {
            ...
            if (this.page < pageNum) {
                ...
                setTimeout(() => {
                    ...
                    let weuserid = this.checkLogin(false)
                        this.$http({
                            method:'post',
                            data:'city=南昌&is_tui=false&tag='+this.tag+'&district='+this.ydDistrict+'&get_cate=true&cate_id='+this.fishfield+'&page='+this.page+'&pagesize='+this.pagesize+'&weuserid='+weuserid+'&latitude='+this.latitude+'&longitude='+this.longitude,
                            url:global.url+'/api/getfishing',
                            header: {  
                              "Content-Type": "application/x-www-form-urlencoded"  
                            },  
        ...
        getlocationinfo(locationinfo){
            ...
            this.$refs.qy.innerText = locationinfo.address
        }
    }
}
</script>
